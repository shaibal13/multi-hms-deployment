                ...
                <div class="adv-table editable-table ">
                    <div class="clearfix">
                        ...
                        <div class="form-group"> 
                            ...
                            <div class="form-group"> 
                                <label for="exampleInputEmail1"><?php echo lang('payment'); ?> <?php echo lang('item_name'); ?> &ast;</label>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo lang('category'); ?> <?php echo lang('price'); ?> &ast;</label>
