<footer class="site-footer">
    <div class="text-center"> 
       <?php echo date('Y'); ?> &copy; <?php echo $this->db->get_where('settings',array('hospital_id'=> $this->session->userdata('hospital_id')))->row()->footer_message;
...
<script src="common/js/jquery.nicescroll.jsssss" type="text/javascript"></script>
